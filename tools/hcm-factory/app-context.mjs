...
const result = {
	...
	reminder:
		'These are catalogue/document-presence indicators, not approval evidence. Read current approved FDD/TDD/domain documents and resolve BLOCKS_THIS_APP decisions before implementation.',
}
