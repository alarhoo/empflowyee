  ...
  values = {
    outputs = {
      ...
      runtime_service_accounts = {
        "marketing-web" = "marketing-web@empflowyee-dev.iam.gserviceaccount.com"
        "account-web"   = "account-web@empflowyee-dev.iam.gserviceaccount.com"
        "account-api"   = "account-api@empflowyee-dev.iam.gserviceaccount.com"
        "hcm-web"       = "hcm-web@empflowyee-dev.iam.gserviceaccount.com"
        "hcm-api"       = "hcm-api@empflowyee-dev.iam.gserviceaccount.com"
        "console-web"   = "console-web@empflowyee-dev.iam.gserviceaccount.com"
        "console-api"   = "console-api@empflowyee-dev.iam.gserviceaccount.com"
      }
    }
  }
}
...
run "seven_dedicated_identities" {
  ...
  assert {
    condition = length(module.service) == 7 && alltrue([
      ...
      service.runtime_service_account == "${name}@empflowyee-dev.iam.gserviceaccount.com"
    ])
