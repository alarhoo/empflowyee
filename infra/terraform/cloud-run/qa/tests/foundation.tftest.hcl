  ...
  values = {
    outputs = {
      ...
      runtime_service_accounts = {
        "marketing-web" = "marketing-web@empflowyee-qa.iam.gserviceaccount.com"
        "account-web"   = "account-web@empflowyee-qa.iam.gserviceaccount.com"
        "account-api"   = "account-api@empflowyee-qa.iam.gserviceaccount.com"
        "hcm-web"       = "hcm-web@empflowyee-qa.iam.gserviceaccount.com"
        "hcm-api"       = "hcm-api@empflowyee-qa.iam.gserviceaccount.com"
        "console-web"   = "console-web@empflowyee-qa.iam.gserviceaccount.com"
        "console-api"   = "console-api@empflowyee-qa.iam.gserviceaccount.com"
      }
    }
  }
}
...
run "seven_dedicated_identities" {
  ...
  assert {
    condition = length(module.service) == 7 && alltrue([
      ...
      service.runtime_service_account == "${name}@empflowyee-qa.iam.gserviceaccount.com"
    ])
...
run "all_services_remain_private" {
  ...
  assert {
    ...
    error_message = "The DEV web access decision must not expose any QA service."
  }
}
