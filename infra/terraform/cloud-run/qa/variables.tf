variable "environment" {
  ...
  validation {
    ...
    error_message = "This Cloud Run root owns only qa."
  }
}
...
variable "project_id" {
  ...
  validation {
    ...
    error_message = "This Cloud Run root owns only empflowyee-qa."
  }
}
...
variable "foundation_state_prefix" {
  ...
  validation {
    condition     = var.foundation_state_prefix == "environments/qa"
    error_message = "Read runtime identities only from environments/qa."
  }
}
