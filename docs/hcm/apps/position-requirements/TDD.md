...
| `position-change-foundation` | unresolved | Positions change-request foundation implemented.  |
| `field-encryption-adr`       | unresolved | Field-encryption ADR accepted for justifications. |
