# Audit Log — functional design

Status: complete for review; approved local business scope, document revision not yet approved.

App `AUDIT_LOG`; owner `audit`; HCM-1 local stage.

## SCOPE

Search real tenant business action evidence.
...
2. Search real tenant business action evidence. Rows come from the append-only store with safe DTO projection.
...
<a id="req-audit-log-001"></a>

## REQ-AUDIT-LOG-001 — Read scoped evidence
...
<a id="req-audit-log-002"></a>

## REQ-AUDIT-LOG-002 — Inspect bounded results
...
<a id="req-audit-log-003"></a>

## REQ-AUDIT-LOG-003 — Handle absent or incomplete evidence
...
<a id="req-audit-log-004"></a>

## REQ-AUDIT-LOG-004 — Authorize independently
...
<a id="req-audit-log-005"></a>

## REQ-AUDIT-LOG-005 — Accessible truthful states
...
<a id="req-audit-log-006"></a>

## REQ-AUDIT-LOG-006 — Persist and attribute correctly
...
Display: Actor ID; action; target type/ID; outcome; timestamp; request correlation.
