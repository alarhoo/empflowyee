...
it('serializes concurrent runners, applies once and exposes only approved objects', /** Race two sessions and verify the protected history and exact approved tables. */ async () => {
	...
	expect(
		...
		[
			...
			'job_architecture_command_receipt',
			'job_band',
			'job_catalogue',
			'job_catalogue_version',
			'job_family',
			'job_grade',
			'job_level',
			'job_profile',
			...
			'person_relationship',
			'position',
			'position_approval_case',
			'position_change_item',
			'position_change_request',
			'position_decision',
			'position_impact_preview',
			'position_relationship',
			'position_requirement',
			'position_version',
			'profile_field_default_policy',
			'profile_field_definition',
			'profile_field_tenant_policy',
