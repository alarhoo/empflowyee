...
const BUSINESS_ENTITLEMENTS: Readonly<Record<string, string>> = {
	...
	// HCM-2 permission register (docs/hcm/tdd/HCM-2-PERMISSION-MATRIX.md).
	'hcm.workforce-foundation.identification-types.read': 'hcm.workforce-foundation',
	'hcm.workforce-foundation.lookups.read': 'hcm.workforce-foundation',
	'hcm.workforce-foundation.lookups.manage': 'hcm.workforce-foundation',
	'hcm.workforce-foundation.structure.read': 'hcm.workforce-foundation',
	'hcm.workforce-foundation.structure.manage': 'hcm.workforce-foundation',
	'hcm.workforce-foundation.org-chart.read': 'hcm.workforce-foundation',
	'hcm.job-architecture.catalogue.read': 'hcm.job-architecture',
	'hcm.job-architecture.catalogue.manage': 'hcm.job-architecture',
	'hcm.job-architecture.catalogue.publish': 'hcm.job-architecture',
	'hcm.job-architecture.positions.read': 'hcm.job-architecture',
	'hcm.job-architecture.positions.request': 'hcm.job-architecture',
	'hcm.job-architecture.positions.approve': 'hcm.job-architecture',
	'hcm.job-architecture.position-requirements.read': 'hcm.job-architecture',
	'hcm.job-architecture.position-requirements.request': 'hcm.job-architecture',
	'hcm.job-architecture.position-requirements.waive': 'hcm.job-architecture',
	'hcm.employee.directory.read': 'hcm.employee',
	'hcm.employee.team.read': 'hcm.employee',
	'hcm.employee.profile.self.read': 'hcm.employee',
	'hcm.employee.profile.self.manage': 'hcm.employee',
	'hcm.employee.records.read': 'hcm.employee',
	'hcm.employee.records.manage': 'hcm.employee',
	'hcm.employee.records.emergency.read': 'hcm.employee',
	'hcm.employee.profile-configuration.read': 'hcm.employee',
	'hcm.employee.profile-configuration.manage': 'hcm.employee',
	'hcm.employee.import.read': 'hcm.employee',
	'hcm.employee.import.manage': 'hcm.employee',
	'hcm.employee.changes.read': 'hcm.employee',
	'hcm.employee.changes.request': 'hcm.employee',
	'hcm.employee.changes.approve': 'hcm.employee',
	'hcm.employee.probation.read': 'hcm.employee',
	'hcm.employee.probation.manage': 'hcm.employee',
	'hcm.employee.probation.review': 'hcm.employee',
	'hcm.employee.hr-service.handle': 'hcm.employee',
	'hcm.employee.hr-service.configure': 'hcm.employee',
	'hcm.employee.hr-requests.self.read': 'hcm.employee',
	'hcm.employee.hr-requests.self.manage': 'hcm.employee',
}
