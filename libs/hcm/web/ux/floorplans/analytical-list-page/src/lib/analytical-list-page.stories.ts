...
const meta: Meta<HcmAnalyticalListPage> = {
	title: 'Floorplans/Composed/Analytical List Page',
	component: HcmAnalyticalListPage,
	decorators: [
		moduleMetadata({
			imports: [Button, Input, Table, TableRow, TableCell, TableHeaderRow, TableHeaderCell, Card],
		}),
	],
	args: {
	...
	render: (args) => ({
		...
		template: `<div class="workshop-page"><ef-hcm-analytical-list-page [title]="title" [summary]="summary" [state]="state" [readOnly]="readOnly" (retry)="retryCount = retryCount + 1">
...
<div hcmAnalytics class="workshop-card-grid"><ui5-card accessibleName="Completion summary"><div class="workshop-card"><h2>Completion</h2><p class="workshop-metric">70%</p><p>Illustrative summary; no chart engine or analytics query.</p></div></ui5-card></div>
<ui5-table accessibleName="Fixture results" overflowMode="Popin">
 ...
 <ui5-table-row><ui5-table-cell>DEMO-043</ui5-table-cell><ui5-table-cell>In review</ui5-table-cell></ui5-table-row>
  ...
  </ef-hcm-analytical-list-page><p role="status">Retry requests: {{ retryCount }}</p></div>`,
	}),
}
export default meta
type Story = StoryObj<HcmAnalyticalListPage>
...
export const ActionState: Story = {
	...
	render: () => ({
		...
		template: `<div class="workshop-page"><ef-hcm-analytical-list-page title="Analytical List Page action fixture">
  ...
  </ef-hcm-analytical-list-page></div>`,
	}),
