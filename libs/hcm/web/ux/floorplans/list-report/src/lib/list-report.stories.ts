...
import { HcmListReport } from './list-report.component'
...
const meta: Meta<HcmListReport> = {
	title: 'Floorplans/Composed/List Report',
	component: HcmListReport,
	decorators: [
		moduleMetadata({
	...
	render: (args) => ({
		...
		template: `<div class="workshop-page"><ef-hcm-list-report [title]="title" [summary]="summary" [state]="state" [readOnly]="readOnly" (retry)="retryCount = retryCount + 1">
...
<ui5-table accessibleName="Fixture results" overflowMode="Popin">
 ...
 <ui5-table-row><ui5-table-cell>DEMO-043</ui5-table-cell><ui5-table-cell>In review</ui5-table-cell></ui5-table-row>
  ...
  </ef-hcm-list-report><p role="status">Retry requests: {{ retryCount }}</p></div>`,
	}),
}
export default meta
type Story = StoryObj<HcmListReport>
...
export const ActionState: Story = {
	...
	render: () => ({
		...
		template: `<div class="workshop-page"><ef-hcm-list-report title="List Report action fixture">
