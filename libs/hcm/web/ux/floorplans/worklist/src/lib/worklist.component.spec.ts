...
describe('HcmWorklist', /** Verify our view-state and retry contract independently of native layout internals. */ () => {
	it('presents denied and empty states distinctly', /** State messages must not imply an empty result is a permission failure. */ () => {
		const fixture = TestBed.createComponent(HcmWorklist)
